...
| :--- | :--- | :--- | :--- | :--- |
| **Task 0.1** | 建立所有現行下載路徑清冊 | `implemented_unverified` | 2026-07-15 | `STATUS.md`, `download-route-inventory.md`, `download-route-inventory.csv` |
| **Task 0.2** | 確認 legacy route 移除與新版量測起點 | `implemented_unverified` | 2026-07-15 | `/go/ads` 已移除，新版版本界線 `e53af6a` |
